...
<figure><img src="../.gitbook/assets/asynchronous-magic.png" alt=""><figcaption></figcaption></figure>

JavaScript 是一门**单线程**的编程语言，意味着**同一时间只能执行一个任务**。然而，现代的 Web 应用程序通常需要处理大量的异步操作，如网络请求、文件读写、用户输入等。如果这些所有操作都是同步的，会导致应用程序在等待某些操作完成时被阻塞，用户体验将变得非常差。
